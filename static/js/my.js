    ...
    $(window).on("load", function () {
      ...
      var mySwiper1 = new Swiper(".swiper-main", {
        ...
        onSlideChangeEnd: function (swiper) {
          ...
          if (
            $(_self).hasClass("endpage") ||
            $(_self).hasClass("swiper-no-swiping")
          ) {
            $(".arrow-up").hide();
          } else {
            $(".arrow-up").show();
      ...
      $(".video-btn").click(function (event) {
        ...
        $(".video-div").append(
          '<iframe height=400 width=640 src="http://player.youku.com/embed/XODU5NjgyMTc2" frameborder=0 allowfullscreen></iframe>'
        );
...
setTimeout(function () {
  /* $('.heart').css('top','10%');
    ...
    $('.title-border').css('width','100%');
    $('.title-text').css('-webkit-animation-name','shake');*/
  $(".slide-2").css("background", "url('images/my/1-back.jpg')");
  $(".slide-2").css("background-size", "100% 100%");
  $(".slide-3").css("background", "url('images/my/background1.jpg')");
